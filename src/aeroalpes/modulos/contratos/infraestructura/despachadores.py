...
class Despachador:
    ...
    def publicar_comando(self, comando, topico):
        ...
        payload = ComandoContratoPayload(
            id_usuario=str(comando.id_usuario)
            # agregar itinerarios
        )
        comando_integracion = ComandoContratoPayload(data=payload)
        self._publicar_mensaje(comando_integracion, topico, AvroSchema(ComandoContratoPayload))
