...
class ActualizarPropiedadHandler(CrearPropiedadBaseHandler):
    
    def handle(self, comando: ActualizarPropiedad):
        print("ActualizarPropiedadDaniel")
        print(comando)
        ...
        print("ActualizarPropiedadHandler")
        print(propiedad_dto)
...
@comando.register(ActualizarPropiedad)
def ejecutar_comando_actualizar_propiedad(comando: ActualizarPropiedad):
    handler = ActualizarPropiedadHandler()
