...
from inquilinos.modulos.contratos.aplicacion.mapeadores import MapeadorContrato
from inquilinos.modulos.contratos.infraestructura.repositorios import RepositorioContratos, RepositorioEventosContratos
