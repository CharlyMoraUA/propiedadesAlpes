from inquilinos.modulos.contratos.dominio.eventos import ContratoCreado
from inquilinos.seedwork.aplicacion.handlers import Handler
from inquilinos.modulos.contratos.infraestructura.despachadores import Despachador
