...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF-Web PropiedadesAlpes"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-contrato", "propiedadesalpes-bff", "public/default/eventos-contrato", eventos=eventos))
    tasks.append(task1)
